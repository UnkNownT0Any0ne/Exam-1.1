   ...
   <main class="main">
      ...
      <section class="section">
         <div class="container">
            ...
            <div class="section__content">
               <img src="#" alt="benefits-img" class="section__img">
               <!-- Преимущества -->
               <ul class="benefits">
      ...
      <section class="section">
         <div class="container">
            ...
            <div class="section__content">
               <!-- Форма записи -->
               <div class="form">
                  <input type="text" class="input" placeholder="Введите ваше ФИО">
                  <input type="text" class="input" placeholder="Введите номер телефона">
                  <input type="email" class="input" placeholder="Введите вашу почту">
                  <input type="text" class="input" placeholder="Введите название услуги">
      ...
      <section class="section">
         <div class="container">
            <div class="section__heading">
               <h2 class="section__title">Новсти</h2>
            </div>
            <div class="section__content">
               <!-- Новости -->
               <div class="news">
                  <div class="new">
                     <img src="#" alt="news" class="new__img">
                     ...
                     <p class="new__date">08.01.2002</p>
                  </div>
                  <div class="new">
                     <img src="#" alt="news" class="new__img">
                     <p class="new__text">Мы сегодня смогли собрать компьютер на базе процессора байкал, с помощью чего запустили сразу же боеголовку!</p>
